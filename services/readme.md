...
The simplemap can be opened in GitHub Pages by modifying the url `https://fleminggeom.github.io/googlemaps-[username]/services/simplemap.html`. Remember to replace the `[username]` portion with your actual GitHub username. 
...
My Directions completed 02 Feb 2022 by CB.
